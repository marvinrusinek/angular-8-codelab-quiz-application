...
export class QuizService {
  ...
  allQuestions: QuizQuestion[] = [
    ...
    {
      questionId: 5,
      questionText: 'Which of the following is the correct way to apply a filter?',
      options: [
    ...
    {
      questionId: 6,
      questionText: 'Interpolation in Angular 2 is done using...',
      options: [
    ...
    {
      questionId: 7,
      questionText: 'Which character is used for chaining multiple pipes in Angular?',
      options: [
        { optionValue: '1', optionText: ':' },
    ...
    {
      questionId: 8,
      questionText: 'Which of the following filters is used to convert input to all uppercase?',
      options: [
    ...
    {
      questionId: 9,
      questionText: 'What is angular.json used for?',
      options: [
    ...
    {
      questionId: 10,
      questionText: 'Which file is responsible for startup of an Angular 2 project?',
      options: [
